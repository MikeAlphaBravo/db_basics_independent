...
describe 'the project creation path', {:type => :feature} do
 ...
 #The detail page includes a form where the project can be updated.
 #This direction was different than the spec so I built to the spec with another page for form.
...
# A user should be able to nagivate to a project's detail page and delete the project.
#Spec details to go to edit to delete project
...
describe 'the project delete path', {:type => :feature} do
  it 'allows a user to delete a project' do
    ...
    visit '/' #mispelling of visit as vist
